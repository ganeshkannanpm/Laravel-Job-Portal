...
class JobFactory extends Factory
{
    ...
    public function definition(): array
    {
        $companies = [
            ...
            'HCL Technologies', 'Tech Mahindra', 'Zoho Corporation',
            'Freshworks', 'Flipkart', 'Paytm', 'PhonePe', 'Reliance Jio',
        ];

        $roles = [
            'PHP Developer', 'Laravel Developer', 'Backend Developer',
            'Full Stack Developer', 'Web Developer',
        ];

        $skillsByRole = [
            'PHP Developer' => ['PHP','Laravel','MySQL','REST APIs','Blade','AJAX','Git','Linux'],
            'Laravel Developer' => ['Laravel','PHP','MySQL','Eloquent ORM','MVC','JWT Authentication','Redis'],
            'Backend Developer' => ['PHP','Laravel','Node.js','MySQL','PostgreSQL','AWS EC2','Docker'],
            'Full Stack Developer' => ['Laravel','PHP','JavaScript','React','MySQL','Tailwind CSS','AWS','Git'],
            'Web Developer' => ['HTML','CSS','JavaScript','PHP','MySQL','Bootstrap'],
        ];

        $locations = [
            'Bangalore, KA','Chennai, TN','Hyderabad, TS','Pune, MH',
            'Noida, UP','Gurgaon, HR','Trivandrum, TVM','Kochi, KL','Coimbatore, TN',
        ];

        $experienceLevels = ['Fresher','1–2 years','2–4 years','5+ years'];
        $salaryRanges = [[300000,600000],[500000,900000],[800000,1500000]];
        $descriptions = [
        ...
        [$salaryMin, $salaryMax] = $this->faker->randomElement($salaryRanges);
        ...
        return [
            ...
            'description' => sprintf($this->faker->randomElement($descriptions), $role),
            'responsibilities' => implode("\n", $this->faker->randomElements($responsibilities, 4)),
            'skills_required' => implode(', ', $skillsByRole[$role]),
            'about_company' => $this->faker->randomElement($aboutCompanies),
            ...
            'posted' => $this->faker->randomElement(['Today','1 day ago','3 days ago','1 week ago']),
            'status' => 'Active',
