...
<body class="bg-gray-50 text-gray-800">
  <main class="max-w-6xl mx-auto p-4 sm:p-6 lg:p-10">
    ...
    <div class="mt-8 flex flex-col sm:flex-row sm:justify-end gap-3">
      <button class="px-4 py-2 border border-gray-200 rounded-lg bg-white">Back to Employers</button>
      <button class="px-4 py-2 bg-green-600 text-white rounded-lg">Message Employer</button>
    </div>
  </main>
</body>
</html>
