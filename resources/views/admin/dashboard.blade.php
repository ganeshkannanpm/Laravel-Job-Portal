        ...
        <aside
            ...
            <div class="p-4 border-b flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-100">Admin</p>
                </div>
            </div>
                ...
                <ul class="space-y-4">
                    ...
                    <li x-data="{ open: false }">
                        <button @click="open = !open"
                            ...
                            <span class="flex items-center"><span class="material-icons mr-2">work</span> Jobs
                                Management</span>
                        ...
                        <ul x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            <li><a href="#" class="block p-2 rounded-lg hover:bg-gray-700 text-gray-100">Job List</a>
                            </li>
                            <li><a href="#" class="block p-2 rounded-lg hover:bg-gray-700 text-gray-100">Job
                                    Applications</a></li>
                            <li><a href="#" class="block p-2 rounded-lg hover:bg-gray-700 text-gray-100">Add new Job</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li x-data="{ open: false }">
                        <button @click="open = !open"
                            ...
                            <span class="flex items-center"><span
                                    class="material-icons mr-2">account_circle</span>Candidates</span>
                            <span class="material-icons text-sm" x-text="open ? 'expand_less' : 'expand_more'"></span>
                        </button>
                        <ul x-show="open" x-transition:enter="transition ease-out duration-200"
                            x-transition:enter-start="opacity-0 transform -translate-y-2"
                            ...
                            x-transition:leave-start="opacity-100 transform translate-y-0"
                            x-transition:leave-end="opacity-0 transform -translate-y-2" class="ml-6 mt-2 space-y-2">
                            <li><a href="#" class="block p-2 rounded-lg hover:bg-gray-700 text-gray-100">Candidate
                                    List</a></li>
                            <li><a href="#" class="block p-2 rounded-lg hover:bg-gray-700 text-gray-100">Resume
                                    Database</a></li>
                            <li><a href="#" class="block p-2 rounded-lg hover:bg-gray-700 text-gray-100">Shortlisted
                                    Candidates</a></li>
                        </ul>
                    </li>
                    ...
                    <li x-data="{ open: false }">
                        <button @click="open = !open"
                            ...
                            :aria-expanded="open.toString()">
                            <span class="flex items-center"><span
                                    class="material-icons mr-2">man_4</span>Employers</span>
                            <span class="material-icons text-sm" x-text="open ? 'expand_less' : 'expand_more'"></span>
                        </button>
                        <ul x-show="open" x-transition:enter="transition ease-out duration-200"
                            x-transition:enter-start="opacity-0 transform -translate-y-2"
                            ...
                            x-transition:leave-start="opacity-100 transform translate-y-0"
                            x-transition:leave-end="opacity-0 transform -translate-y-2" class="ml-6 mt-2 space-y-2">
                            <li><a href="#" class="block p-2 rounded-lg hover:bg-gray-700 text-gray-100">Employer
                                    List</a></li>
                            <li><a href="#" class="block p-2 rounded-lg hover:bg-gray-700 text-gray-100">Company
                                    Profiles</a></li>
                        </ul>
                    </li>
                    ...
                    <li x-data="{ open: false }">
                        <button @click="open = !open"
                            ...
                            :aria-expanded="open.toString()">
                            <span class="flex items-center"><span
                                    class="material-icons mr-2">settings</span>Settings</span>
                            <span class="material-icons text-sm" x-text="open ? 'expand_less' : 'expand_more'"></span>
                        </button>
                        <ul x-show="open" x-transition:enter="transition ease-out duration-200"
                            x-transition:enter-start="opacity-0 transform -translate-y-2"
                            ...
                            x-transition:leave-start="opacity-100 transform translate-y-0"
                            x-transition:leave-end="opacity-0 transform -translate-y-2" class="ml-6 mt-2 space-y-2">
                            <li><a href="#" class="block p-2 rounded-lg hover:bg-gray-700 text-gray-100">General
                                    Settings</a></li>
                            <li><a href="#" class="block p-2 rounded-lg hover:bg-gray-700 text-gray-100">Role
                                    Management</a></li>
                        </ul>
                    </li>
                    ...
                    <li x-data="{ open: false }">
                        <button @click="open = !open"
                            class="flex items-center justify-between w-full p-2 rounded-lg transition-colors duration-150 hover:bg-gray-700 text-gray-100"
                            :aria-expanded="open.toString()">
                            <span class="flex items-center"><span class="material-icons mr-2">mail</span>Messages</span>
                            <span class="material-icons text-sm" x-text="open ? 'expand_less' : 'expand_more'"></span>
                        </button>
                        <ul x-show="open" x-transition:enter="transition ease-out duration-200"
                            x-transition:enter-start="opacity-0 transform -translate-y-2"
                            ...
                            x-transition:leave-start="opacity-100 transform translate-y-0"
                            x-transition:leave-end="opacity-0 transform -translate-y-2" class="ml-6 mt-2 space-y-2">
                            <li><a href="#" class="block p-2 rounded-lg hover:bg-gray-700 text-gray-100">Inbox</a></li>
                            <li><a href="#" class="block p-2 rounded-lg hover:bg-gray-700 text-gray-100">Sent</a></li>
                            <li><a href="#" class="block p-2 rounded-lg hover:bg-gray-700 text-gray-100">Job Seeker
                                    Queries</a></li>
                            <li><a href="#" class="block p-2 rounded-lg hover:bg-gray-700 text-gray-100">Employer
                                    Queries</a></li>
                            <li><a href="#" class="block p-2 rounded-lg hover:bg-gray-700 text-gray-100">System
                                    Announcements</a></li>
                        </ul>
                    </li>
                    ...
                    <table class="w-full border-collapse text-sm md:text-base">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b">
                                ...
                                <td class="p-3">
                                    <span
                                        class="bg-green-100 text-green-700 px-2 py-1 rounded-full text-xs">Success</span>
                                </td>
                                <td class="p-3 flex space-x-2">
                                    <button class="text-green-600 hover:text-green-800">✔</button>
                                    <button class="text-red-600 hover:text-red-800">✘</button>
