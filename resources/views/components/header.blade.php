<div class="bg-gray-100 px-6 fixed top-0 left-0 right-0 z-50 shadow-lg">
    <nav class="flex justify-between items-center py-4 text-gray-900">
        ...
        <div class="hidden md:flex space-x-6 font-semibold">
            <a href="/register"
                class="px-4 py-2 bg-indigo-600 text-gray-100 rounded-full hover:bg-indigo-800 hover:text-gray-100">Sign
                Up</a>
            <a href="/login"
                class="px-4 py-2 bg-indigo-600 text-gray-100 rounded-full hover:bg-indigo-800 hover:text-gray-100">Log
                In</a>
            <a href="{{ route('employer-register.create') }}"
                class="px-4 py-2  text-gray-900 rounded-full hover:bg-indigo-800 hover:text-gray-100">Employer</a>
        </div>
