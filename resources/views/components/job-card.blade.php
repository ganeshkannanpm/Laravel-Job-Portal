<div class="mx-5 bg-white border border-gray-200 rounded-xl shadow-sm p-5 hover:shadow-md transition relative">
     ...
     <!-- Save Job Button -->
    <button 
        class="absolute top-2 right-2 text-black hover:text-red-500 save-job-btn">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" 
             viewBox="0 0 24 24" stroke-width="1.5" 
             stroke="currentColor" class="w-6 h-6 heart-icon">
            <path stroke-linecap="round" stroke-linejoin="round" 
                  d="M21 8.25c0-2.485-2.014-4.5-4.5-4.5-1.77 0-3.292 
                     1.02-4.031 2.482C11.792 4.77 10.27 3.75 
                     8.5 3.75 6.014 3.75 4 5.765 4 
