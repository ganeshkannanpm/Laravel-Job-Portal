...
<nav class="fixed top-0 left-0 right-0 bg-white shadow-md px-6 py-4 flex justify-between items-center z-50">
    ...
    <ul class="hidden md:flex space-x-6">
        ...
        <li><a href="#" class="text-gray-700 hover:text-indigo-800 no-underline hover:underline">Manage Employers</a></li>
        <li><a href="#" class="text-gray-700 hover:text-indigo-800 no-underline hover:underline">Manage Candidates</a></li>
        <li><a href="#" class="text-gray-700 hover:text-indigo-800 no-underline hover:underline">Jobs Approval</a></li>
        <li><a href="#" class="text-gray-700 hover:text-indigo-800 no-underline hover:underline">Reports</a></li>
        <li><a href="#" class="text-gray-700 hover:text-indigo-800 no-underline hover:underline">Settings</a></li>
    </ul>
