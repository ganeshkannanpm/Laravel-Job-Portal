    ...
    <section class="ms-5 overflow-auto">
        ...
        <div class="w-full mx-auto  rounded-lg p-8">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Create your Profile</h2>
            </div>
            ...
            <form action="{{ route('user.store-personal-info') }}" method="POST" class="grid grid-cols-2 gap-6">
                @csrf
                <!-- Full Name -->
                <div>
                ...
                <div>
                    ...
                    <input type="email" name="email" class="mt-1 block w-full border-gray-300 rounded-lg p-2" required>
                </div>

                <!-- Phone -->
                <div>
                    <label class="block text-gray-900 font-medium">Phone</label>
                    <input type="text" name="phone" class="mt-1 block w-full border-gray-300 rounded-lg p-2" required>
                </div>
