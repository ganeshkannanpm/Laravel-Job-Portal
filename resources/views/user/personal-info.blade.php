                ...
                @if ($personalInfo)
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="gender" readonly value="{{ old('gender', $personalInfo->gender ?? '') }}"
                                class="mt-1 block w-full border-gray-300 rounded-lg p-2 cursor-not-allowed">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="email" name="email" readonly value="{{ old('email', $personalInfo->email ?? '') }}"
                                class="mt-1 block w-full border-gray-300 rounded-lg p-2 cursor-not-allowed" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" readonly value="{{ old('phone', $personalInfo->phone ?? '') }}"
                                class="mt-1 block w-full border-gray-300 rounded-lg p-2 cursor-not-allowed" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="state" readonly value="{{ old('state', $personalInfo->state ?? '') }}"
                                class="mt-1 block w-full border-gray-300 rounded-lg p-2 cursor-not-allowed">
                        </div>
