        ...
        <div class="space-y-4">
            ...
            <div class="pl-4 flex justify-between items-start">
                <div class="border-l-4 border-indigo-600 pl-4 mb-6">
                    <h3 class="text-xl font-semibold text-gray-700">Bachelor of Computer Science</h3>
                    <p class="text-gray-600">XYZ University • 2018 - 2021</p>
                    <p class="text-gray-500 mt-1">Focused on Software Development, Database Management, and Web
                        Technologies.
                    </p>
                </div>
                <!-- Action Buttons -->
